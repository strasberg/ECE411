echo "--- Executing initialization force file for ../testcode/ldiStiTest.asm ---"
...
echo "Done initializing processor, loading ../testcode/ldiStiTest.asm program code."
run 5
...
run 5
echo "Done loading ../testcode/ldiStiTest.asm program code."
